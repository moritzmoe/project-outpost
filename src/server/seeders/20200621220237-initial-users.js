...
module.exports = {
  up: (queryInterface, Sequelize) => queryInterface.bulkInsert('Users', [
    ...
    { email: 'user@test.com', firstname: 'Owner', lastname: 'Test', password: '$2b$10$GeIsqHnWqFKFH8CiHlce.eT5bjEvbH5LYZJLZHtBuWdnqi1l89pJK', role: 1, createdAt: new Date(), updatedAt: new Date() }
  ], {}),
