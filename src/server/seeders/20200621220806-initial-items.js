...
module.exports = {
  up: (queryInterface, Sequelize) => queryInterface.bulkInsert('Items', [
    { name: 'Bio Black Tiger Garnelen', weight: 160, categoryId: 13, barcode: '4388844025929', packaging: 13, origin: 1, score: 2214, createdBy: 1, lastUpdatedBy: 1, createdAt: new Date(), updatedAt: new Date(), approved: 1 },
